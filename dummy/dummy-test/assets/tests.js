  ...
  function executeTest(testName, callback, additionalBeforeEachSettings) {
    ...
    (0, _qunit.module)('Acceptance | flexberry-lookup-base |' + testName, {
      beforeEach: function beforeEach() {
        ...
        if (!_ember['default'].isNone(additionalBeforeEachSettings) && typeof additionalBeforeEachSettings === 'function') {
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-default-user-setting-test', ['exports', 'ember', 'dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (exports, _ember, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest) {

  (0, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest.executeTest)('flexberry-lookup render olv with default user setting test', function (store, assert) {
    assert.expect(2);
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-prefer-developer-to-default-user-setting-test', ['exports', 'ember', 'dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (exports, _ember, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest) {

  (0, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest.executeTest)('flexberry-lookup prefer developer to default user setting test', function (store, assert) {
    assert.expect(2);
    ...
    var controller = app.__container__.lookup('controller:components-examples/flexberry-lookup/user-settings-example');
    controller.set('notUseUserSettings', true);

    var route = app.__container__.lookup('route:components-examples/flexberry-lookup/user-settings-example');
...
/* global visit, andThen, currentURL */
/* eslint-disable ember/no-test-and-then */
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-prefer-stored-to-default-user-setting-test', ['exports', 'ember', 'dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (exports, _ember, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest) {

  (0, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest.executeTest)('flexberry-lookup prefer stored to default user setting test', function (store, assert) {
    assert.expect(2);
...
define('dummy/tests/unit/services/device-test', ['exports', 'ember', 'qunit', 'sinon', 'ember-flexberry/services/device'], function (exports, _ember, _qunit, _sinon, _emberFlexberryServicesDevice) {

  /* eslint-disable-next-line qunit/no-global-module-test */ // https://github.com/platinumazure/eslint-plugin-qunit/issues/75
  (0, _qunit.module)('Unit | Service | device', {
    beforeEach: function beforeEach() {
      _sinon['default'].stub(_ember['default'], 'getOwner').returns({ application: { deviceService: {} } });
    },
    afterEach: function afterEach() {
      _ember['default'].getOwner.restore();
    }
  });

  /* eslint-disable-next-line qunit/no-global-module-test */
  (0, _qunit.test)('device service isMobile work', function (assert) {
    var service = _emberFlexberryServicesDevice['default'].create();
